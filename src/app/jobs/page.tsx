...
const OFFERS: JobOffer[] = [
  {
    ...
    summary:
      "Vous accompagnez les propriétaires, acquéreurs et investisseurs dans la vente, l'achat et la location de biens résidentiels.",
    href: "/jobs/agent-immobilier-ipi",
  ...
  },
  {
    ...
    href: "/jobs/stagiaire-ifapme-efp",
  ...
  },
  {
    ...
    href: "/jobs/office-manager",
    icon: <BriefcaseBusiness size={18} strokeWidth={1.8} />,
  },
];

const PROFILE_ITEMS = [
  "Vous avez le sens du contact et la fibre commerciale.",
  "Vous êtes rigoureux, motivé et proactif.",
...
const OFFER_ITEMS = [
  "Une notoriété reconnue depuis plus de 10 ans.",
  "Une structure organisée et en pleine expansion.",
  "Un accompagnement et des formations continues.",
  "Un support administratif, informatique et marketing.",
    ...
    <section className="relative bg-ink text-white overflow-hidden">
      ...
      <div className="relative max-w-[1480px] mx-auto px-6 lg:px-10 pt-28 pb-16 lg:pt-32 lg:pb-24">
        <div className="max-w-[760px]">
          <SectionEyebrow tone="dark">Jobs</SectionEyebrow>
          <h1 className="mt-6 text-[40px] sm:text-[52px] lg:text-[64px] font-extrabold tracking-tight leading-[1.02]">
            Rejoignez une agence immobilière en pleine croissance
            <span className="text-accent">.</span>
          </h1>
          <p className="mt-6 text-base lg:text-lg text-white/80 leading-relaxed max-w-[640px]">
            Vous êtes passionné par l&apos;immobilier et souhaitez évoluer au
            sein d&apos;une agence reconnue en Brabant wallon ? Découvrez nos
            opportunités et rejoignez une équipe dynamique, ambitieuse et
            orientée résultats.
          </p>
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <CTAButton href="#offres" variant="primary">
              Voir les offres
            </CTAButton>
...
function Offres() {
  return (
    <section id="offres" className="bg-cream scroll-mt-24">
      <div className="max-w-[1480px] mx-auto px-6 lg:px-10 py-16 lg:py-24">
        <div className="max-w-[760px] mb-12 lg:mb-14">
          <SectionEyebrow tone="light">Offres d&apos;emploi</SectionEyebrow>
          ...
          <p className="mt-5 text-[15.5px] text-ink/70 leading-relaxed">
            Consultez nos offres d&apos;emploi et découvrez les postes
            actuellement ouverts au sein de notre agence.
          </p>
        </div>
...
/* ─────────────── PROFIL + AVANTAGES (WHITE) ─────────────── */

function ProfilAvantages() {
  return (
...
function CandidatureForm() {
  ...
  return (
    <form
      ...
      className="bg-[#ebebe5] rounded-[18px] p-6 lg:p-8 space-y-5 ring-1 ring-inset ring-black/[0.06] shadow-[0_24px_50px_-20px_rgba(15,23,42,0.18)]"
    >
