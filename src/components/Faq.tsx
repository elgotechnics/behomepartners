      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-8 pt-20 lg:pt-24 pb-20 lg:pb-24">
        <div className="max-w-[720px] mx-auto text-center mb-14">
          ...
          <p className="text-base text-ink/70 leading-relaxed">
            Les réponses aux questions que se posent le plus souvent nos
            clients — frais, mandats, délais, secteur couvert.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch max-w-[1424px] mx-auto">
          <div className="relative aspect-[4/5] lg:aspect-auto lg:min-h-[520px] overflow-hidden rounded-[14px] bg-grid lg:max-w-[540px] lg:ml-auto lg:w-full 2xl:max-w-none">
            <Image
